...
translations = {
    ...
    "FloatBoat এর কাঠের ইন্টেরিয়র": "Wooden interior of FloatBoat",
    "প্রিমিয়াম কেবিন বেড": "Premium cabin bed",
    "ছাদের ডেকে খাবারের আয়োজন": "Dining arrangement on rooftop deck",
    "FloatBoat হাউসবোটের বাইরের দৃশ্য": "Exterior view of FloatBoat houseboat",
    "হাওরের মাঝে FloatBoat": "FloatBoat in Haor waters",
    ...
    "FloatBoat কেবিনের বিছানা": "FloatBoat cabin bed",
    ...
    "মেঘলা আকাশের নিচে FloatBoat": "FloatBoat under cloudy sky",
    ...
    "FloatBoat এর লাউঞ্জ এরিয়া": "Lounge area of FloatBoat",
    "অতিথিদের আনন্দময় মুহূর্ত": "Joyful moments of guests",
    "FloatBoat লোগো কর্নার": "FloatBoat logo corner",
