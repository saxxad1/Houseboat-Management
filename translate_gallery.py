...
translations = {
    ...
    "Floatbase এর কাঠের ইন্টেরিয়র": "Wooden interior of Floatbase",
    "প্রিমিয়াম কেবিন বেড": "Premium cabin bed",
    "ছাদের ডেকে খাবারের আয়োজন": "Dining arrangement on rooftop deck",
    "Floatbase হাউসবোটের বাইরের দৃশ্য": "Exterior view of Floatbase houseboat",
    "হাওরের মাঝে Floatbase": "Floatbase in Haor waters",
    ...
    "Floatbase কেবিনের বিছানা": "Floatbase cabin bed",
    ...
    "মেঘলা আকাশের নিচে Floatbase": "Floatbase under cloudy sky",
    ...
    "Floatbase এর লাউঞ্জ এরিয়া": "Lounge area of Floatbase",
    "অতিথিদের আনন্দময় মুহূর্ত": "Joyful moments of guests",
    "Floatbase লোগো কর্নার": "Floatbase logo corner",
