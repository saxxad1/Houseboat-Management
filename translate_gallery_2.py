...
translations = {
    ...
    "FloatBoat এর কাঠের ইন্টেরিয়র": "Wooden interior of FloatBoat",
    "প্রিমিয়াম কেবিন বেড": "Premium cabin bed",
    "রুফটপ ডেকে খাবারের আয়োজন": "Dining arrangement on rooftop deck",
    "হাওরের পানিতে FloatBoat": "FloatBoat in Haor waters",
    ...
    "FloatBoat কেবিন বেড": "FloatBoat cabin bed",
    ...
    "মেঘলা আকাশে FloatBoat": "FloatBoat under cloudy sky",
    ...
    "FloatBoat এর লাউঞ্জ এরিয়া": "Lounge area of FloatBoat",
